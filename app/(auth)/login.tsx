          ...
          <View style={styles.cardContainer}>
            ...
            <View style={styles.card}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
              >
                <LinearGradient colors={["#47538bff", "#6d75a0ff", "#47538bff"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.buttonGradient}>
                  {loading ? (
...
const styles = StyleSheet.create({
  ...
  shape1: { position: "absolute", width: 400, height: 400, borderRadius: 200, backgroundColor: "#74b7d4ff", opacity: 0.15, top: -200, right: -150, ...(Platform.select({ web: { filter: "blur(80px)" as any } }) as any) },
  shape2: { position: "absolute", width: 350, height: 350, borderRadius: 175, backgroundColor: "#474e8bff", opacity: 0.1, bottom: -100, left: -100, ...(Platform.select({ web: { filter: "blur(70px)" as any } }) as any) },
  shape3: { position: "absolute", width: 250, height: 250, borderRadius: 125, backgroundColor: "#a7b6c9ff", opacity: 0.2, top: "50%", left: "50%", marginLeft: -125, marginTop: -125, ...(Platform.select({ web: { filter: "blur(60px)" as any } }) as any) },
  ...
  ambientShadow: { position: "absolute", top: 30, left: 20, right: 20, bottom: -30, backgroundColor: "#47538bff", opacity: 0.15, borderRadius: 28, ...(Platform.select({ web: { filter: "blur(40px)" as any } }) as any) },
  card: {
    ...
    ...(Platform.select({
      ...
      default: { elevation: 8, shadowColor: "#4d478bff", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 30 },
    }) as any),
  },
  ...
  logoFrame: {
    width: 96, height: 96, borderRadius: 48, backgroundColor: "#f6f6faff", alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#52478b33",
    ...(Platform.select({
      web: { boxShadow: "0 8px 24px rgba(77, 71, 139, 0.1)" as any },
      default: { elevation: 4, shadowColor: "#47558bff", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8 },
    }) as any),
  },
  logo: { width: 64, height: 64 },
  title: { fontSize: 36, fontWeight: "300", color: "#2c2c2cff", textAlign: "center", marginBottom: 4, letterSpacing: 1 },
  subtitle: { fontSize: 14, color: "#757575ff", textAlign: "center", marginBottom: 36, fontWeight: "400" },
